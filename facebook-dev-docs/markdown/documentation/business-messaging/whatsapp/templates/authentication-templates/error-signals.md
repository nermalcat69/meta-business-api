...
source_url: https://developers.facebook.com/documentation/business-messaging/whatsapp/templates/authentication-templates/error-signals
---
...
* Explicitly verifying that your user owns the WhatsApp account as you would any other new authentication channel, by sending, for example, an initial OTP and having the user enter it in your app during registration or while they are logged in.
...
To combat phishing, WhatsApp disables [forwarding⁠](https://faq.whatsapp.com/887468535575482/?fbclid=IwZXh0bgNhZW0CMTAAYnJpZBExdDFTU2F3MEdKRXZxdWxzRXNydGMGYXBwX2lkEDIyMjAzOTE3ODgyMDA4OTIAAR7oEMK2NJZAxTQqe7VdJvDGgH5ALRF9aD4dmIfjfQYoNcgIksueVxUArMra4g_aem_l6T89rF0Qb_d2HGAcYk5JA) of authentication messages. Messages travel end-to-end encrypted between [Cloud API and the user](https://developers.facebook.com/documentation/business-messaging/whatsapp/data-privacy-and-security).

WhatsApp does not support and cannot validate the security practices of [unofficial apps⁠](https://faq.whatsapp.com/1217634902127718?fbclid=IwZXh0bgNhZW0CMTAAYnJpZBExdDFTU2F3MEdKRXZxdWxzRXNydGMGYXBwX2lkEDIyMjAzOTE3ODgyMDA4OTIAAR516SvNTWneWJ1BRyPN_AUwkutE4mEG3HfgWLNwp2vKQNk5dxI0lA9ItJirSg_aem_0fRiwIWcHro6u8toSKri-Q). There is no guarantee that authentication via WhatsApp is secure for users who use these apps.

## UX

### Collect opt-in

Per the [WhatsApp Business Messaging Policy⁠](https://www.whatsapp.com/legal/business-policy/?fbclid=IwZXh0bgNhZW0CMTAAYnJpZBExdDFTU2F3MEdKRXZxdWxzRXNydGMGYXBwX2lkEDIyMjAzOTE3ODgyMDA4OTIAAR7oEMK2NJZAxTQqe7VdJvDGgH5ALRF9aD4dmIfjfQYoNcgIksueVxUArMra4g_aem_l6T89rF0Qb_d2HGAcYk5JA), you must get opt-in before you can send a message to a WhatsApp user. A common implementation is to offer users a choice of authentication channels (such as WhatsApp, email, and SMS), as shown in [our sample application](https://developers.facebook.com/documentation/business-messaging/whatsapp/templates/authentication-templates/authentication-templates#sample-app).
...
Every business must have its own WhatsApp Business account and be sending authentication templates through its own phone number, as opposed to sharing WABAs and phone numbers with separate business entities. Sharing a WABA across multiple businesses is against policy as it conflicts with the [WhatsApp Business Terms of Service⁠](https://www.whatsapp.com/legal/business-terms?fbclid=IwZXh0bgNhZW0CMTAAYnJpZBExdDFTU2F3MEdKRXZxdWxzRXNydGMGYXBwX2lkEDIyMjAzOTE3ODgyMDA4OTIAAR7WlgU2D_nYpi9cfvPiwHW3pAcJ4ioAXwByWSEi00HO80ot2z93xPB4iJDu-w_aem_adl3wSgC9B3Pu089VwUlWQ) and [WhatsApp Business Messaging Policy⁠](https://www.whatsapp.com/legal/business-policy/?fbclid=IwZXh0bgNhZW0CMTAAYnJpZBExdDFTU2F3MEdKRXZxdWxzRXNydGMGYXBwX2lkEDIyMjAzOTE3ODgyMDA4OTIAAR4Gyix9SeTw6091BlLDa8L1G5d_IkKU991tQBUQRCo8ZB1LwdhRduYcZpxAog_aem_FIN9kFgm_K-iiNno_LesBg), in addition to creating poor user and business experiences on WhatsApp.
