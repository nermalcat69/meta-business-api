...
source_url: https://developers.facebook.com/documentation/business-messaging/whatsapp/templates/authentication-templates/copy-code-button-authentication-templates
---
...
* Link to our [About security codes that automatically fill on WhatsApp⁠](https://faq.whatsapp.com/659113242716268/?fbclid=IwZXh0bgNhZW0CMTAAYnJpZBExdDFTU2F3MEdKRXZxdWxzRXNydGMGYXBwX2lkEDIyMjAzOTE3ODgyMDA4OTIAAR516SvNTWneWJ1BRyPN_AUwkutE4mEG3HfgWLNwp2vKQNk5dxI0lA9ItJirSg_aem_0fRiwIWcHro6u8toSKri-Q) help center article if your users are worried about auto-delivery of the password or code.
...
![Two Android verification screens showing Autofill via WhatsApp options that tell users the code will fill in automatically](https://scontent.fdel1-2.fna.fbcdn.net/v/t39.2365-6/391694662_849209140220804_774216131431245181_n.png?_nc_cat=109&_nc_map=urlgen_bucketless&ccb=1-7&_nc_sid=e280be&_nc_ohc=0_1iR_ZXo3IQ7kNvwFAZwI0&_nc_oc=Adr1QLM7QpjdD_B6Cc6XSoisgah8vGB9TF77VYjmfcAkQ8fPZ_m1ZSXnLkAnytsTX74pMd3Yj9iVvIewc4gm6hsd&_nc_zt=14&_nc_ht=scontent.fdel1-2.fna&_nc_gid=MA5f9sTvIj9h9sukjI7uvg&_nc_ss=7b2a8&oh=00_AQDF08BjBuAMdPVGE5KwbwIgXK1YJ5o8R08xfMEaBdsIKw&oe=6A603FEA)
...
When a user in your app requests a password or code to be delivered to their WhatsApp number, first [initiate the handshake](https://developers.facebook.com/documentation/business-messaging/whatsapp/templates/authentication-templates/copy-code-button-authentication-templates#initiating-the-handshake), then call our API to send the authentication template message. When the WhatsApp client receives the message, it will perform an [eligibility check](https://developers.facebook.com/documentation/business-messaging/whatsapp/templates/authentication-templates/copy-code-button-authentication-templates#eligibility-check), and if there are no errors, start a broadcast.
