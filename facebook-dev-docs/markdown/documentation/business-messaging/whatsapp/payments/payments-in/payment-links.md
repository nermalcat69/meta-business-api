---
title: "Integrate the CCAvenue payment gateway"
source_url: https://developers.facebook.com/documentation/business-messaging/whatsapp/payments/payments-in/payment-links
---
...
![Sequence diagram of WhatsApp UPI Intent checkout flow between Buyer, WhatsApp, Business Service Provider, Seller, and CCAvenue](https://scontent.fdel1-1.fna.fbcdn.net/v/t39.2365-6/582933363_2600727520301874_3735890498928031759_n.png?_nc_cat=105&_nc_map=urlgen_bucketless&ccb=1-7&_nc_sid=e280be&_nc_ohc=zeIArJFV6aQQ7kNvwEKX_Z7&_nc_oc=AdpMxn6J6Id8PDFduJAlarBtQntif-0BtKVYs-_cLnu9-tkDDTmoRMY3iW57Cr5XZQfKFet3365xqIquArFNgOlp&_nc_zt=14&_nc_ht=scontent.fdel1-1.fna&_nc_gid=wKcqgVeHFbKu-zTISifQTQ&_nc_ss=7b2a8&oh=00_AQBSjPRiYu_tWnAy8P-ZyGcxMnTDnFI5-h_N_aPVWGXA4w&oe=6A605975)
...
| `order_id` | This ID is used by merchants to identify the order. Ensure that you send a unique id with each request. | Alphanumeric (30) Characters allowed: Alphabet (A-Z), (a-z), Numbers, - (hyphen), / (slash) ,\_ (underscore) |
| `currency` | The currency in which you want to process the transaction. INR – Indian Rupee | “INR” |
| `amount` | Order Amount | Numeric (12, 2) |
| `redirect_url` | CCAvenue will post the status of the order along with the parameters to this URL. If you do not send this value, order status will be sent back to the URL configured in dynamic event notifications module in your MARS account. If there is no URL configured in the MARS account, PG will display the status of the order on the CCAvenue confirmation page. | Alphanumeric (100) Characters allowed: Alphabet (A-Z), (a-z), Numbers, / (slash),\_ (underscore) |
| `card_type` | Type of card used by the customer.  UPI | “UPI” |
| `card_name` | Name of the card used by the customer. This list will be provided by CCAvenue.  UPI | “UPI” |
