...
source_url: https://developers.facebook.com/documentation/business-messaging/whatsapp/payments/payments-in/pg
---
...
**Superfast Setup**: Merchants can independently create the required [WhatsApp templates](https://developers.facebook.com/documentation/business-messaging/whatsapp/payments/payments-in/pg#template-requirements) and embed payment links from [supported payment gateways](https://developers.facebook.com/documentation/business-messaging/whatsapp/payments/payments-in/pg#supported-payment-gateways) - no BSP involvement is needed.
...
![WhatsApp chat with Jasper's Market showing an enhanced payment bubble for ₹100.00 with card icons and a 'Pay now' button](https://scontent.fdel1-1.fna.fbcdn.net/v/t39.2365-6/564690767_1339318147926836_7876647427034457125_n.jpg?_nc_cat=102&_nc_map=urlgen_bucketless&ccb=1-7&_nc_sid=e280be&_nc_ohc=_SNrJ_48nd8Q7kNvwGoYW76&_nc_oc=AdpLTabI0jfTPpbj7z7CCml8hS1wMQwSqhuIAc-8CWtz4B_5jJnvLtnl4IkG-mKCP7PH3e3GbayZl5l9Kow1SPXh&_nc_zt=14&_nc_ht=scontent.fdel1-1.fna&_nc_gid=oxyxfMUU6WnFuBY3Czk7ww&_nc_ss=7b2a8&oh=00_AQDDMKESOxZTlgMNh80XYbS3Qs0rAgy5krnizcWMUGzYBg&oe=6A604B13)

* **Rich Payment Card**: Displays Amount, currency, and CTA button
* **In-App Checkout**:
...
| **Compliant Template** | A message template configured with no header and a dynamic URL button (see [Template Requirements](https://developers.facebook.com/documentation/business-messaging/whatsapp/payments/payments-in/pg#template-requirements)) |
...
![End-to-end EPL flow: Merchant creates payment link via PG, sends template message, consumer pays in-app, PG sends webhook to merchant (unchanged), WhatsApp updates payment card automatically](https://scontent.fdel1-7.fna.fbcdn.net/v/t39.2365-6/651759898_1455745979617385_4466368405017366786_n.png?_nc_cat=109&_nc_map=urlgen_bucketless&ccb=1-7&_nc_sid=e280be&_nc_ohc=uZjuQP1NuuoQ7kNvwEy8zvD&_nc_oc=Adp0hXvCZp0lp8MFcQ4Je_JNqMoWNFUwfd-AMXoEB1be08RXHeEVsAAm9bagbvOAepj9ngmi-2LIM-lcYZW0_9wG&_nc_zt=14&_nc_ht=scontent.fdel1-7.fna&_nc_gid=oxyxfMUU6WnFuBY3Czk7ww&_nc_ss=7b2a8&oh=00_AQAxSbe1kvExKJ85H2Y0cR8OSC6r3qXR9S7tquWwrbyPmw&oe=6A607450)
...
| **Button** | Exactly **one** dynamic URL button with a [supported PG link prefix](https://developers.facebook.com/documentation/business-messaging/whatsapp/payments/payments-in/pg#dynamic-url-prefix-configuration) |
...
* [Template Library](https://developers.facebook.com/documentation/business-messaging/whatsapp/templates/template-library) (recommended)
* [WhatsApp Manager⁠](https://business.facebook.com/wa/manage/message-templates)
* [Business Management API](https://developers.facebook.com/documentation/business-messaging/whatsapp/templates/overview)
* BSP Dashboard
...
* **Cashfree**: [Payment Links⁠](https://www.cashfree.com/docs/payments/no-code/payment-link?fbclid=IwZXh0bgNhZW0CMTAAYnJpZBExdDFTU2F3MEdKRXZxdWxzRXNydGMGYXBwX2lkEDIyMjAzOTE3ODgyMDA4OTIAAR5BDBNis-WtphCB_DUQostqjZvI4stmKVZInwoZUV-S6pj0Kb0sJbazp0vo8A_aem_vvUuXnnpV8HeG1VtjjNAcQ)
