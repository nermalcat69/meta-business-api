...
* *Enter your existing business portfolio name in the [business portfolio screen](https://developers.facebook.com/documentation/business-messaging/whatsapp/embedded-signup/default-flow#business-portfolio-screen).*
* *Create a new WhatsApp Business account (WABA) in the [WABA selection screen](https://developers.facebook.com/documentation/business-messaging/whatsapp/embedded-signup/default-flow#business-asset-selection-screen).*
* *Enter your existing business phone number in the [phone number addition screen](https://developers.facebook.com/documentation/business-messaging/whatsapp/embedded-signup/default-flow#phone-number-addition-screen). This will trigger a warning that the number will be moved to a new WhatsApp Business account.*

![Embedded Signup phone number addition screen with a warning that the number will be moved to a new WhatsApp Business account.](https://scontent.fdel1-3.fna.fbcdn.net/v/t39.2365-6/466392707_1274428157316091_5418623531369238611_n.png?_nc_cat=110&_nc_map=urlgen_bucketless&ccb=1-7&_nc_sid=e280be&_nc_ohc=O-sD6ANncvsQ7kNvwE1XLx-&_nc_oc=Adpvia_uTJP2fjQfzCdTlaod_79Unp0wBEjWdQCWvAYpl2dYKpbMD55iwcdPPFwsrIVXte1ZPOvf5N3u-sP_Cpvz&_nc_zt=14&_nc_ht=scontent.fdel1-3.fna&_nc_gid=pWLCJfM1DoroSc4_mtTtOg&_nc_ss=7b2a8&oh=00_AQCfFbWqxVfbwjiQa5NAZ3_xyB7yTnxEyJSBtOq1zvEbeA&oe=6A606B35)
