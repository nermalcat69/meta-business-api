---
title: "No Storage"
source_url: https://developers.facebook.com/documentation/business-messaging/whatsapp/getting-opt-in
---
...
![Cloud API No Storage message flow: Business or BSP to WhatsApp API Client in Meta U.S. with 1-hour Message Cache, to WhatsApp infra to Consumer](https://scontent.fdel1-8.fna.fbcdn.net/v/t39.2365-6/559308894_1116451836859295_8169970485040161301_n.png?_nc_cat=102&_nc_map=urlgen_bucketless&ccb=1-7&_nc_sid=e280be&_nc_ohc=SOqvcEwxgGYQ7kNvwEcAuZ6&_nc_oc=AdoRvn_GLgX_fdlXX3rmp6eoPZxti03j2Zm43iqhB5WD17vTMjqamN8JhG7qlX-MEIdP8XJS2hWn1F7CS6IAe-Oo&_nc_zt=14&_nc_ht=scontent.fdel1-8.fna&_nc_gid=_074QhYhaG1ob79opx8R2A&_nc_ss=7b2a8&oh=00_AQCaunD22ZqhCuVohBNSghR7H87pQ-Cki9r85OzmK0W9CQ&oe=6A605255)
...
* **Message decryption failures** — If a message fails to decrypt on the consumer side, Cloud API can only retry sending the message within a 1-hour TTL window. After this 1-hour window, Cloud API cannot retry the message. You will receive an error webhook indicating the failure. See: [Retry Receipt Failures](https://developers.facebook.com/documentation/business-messaging/whatsapp/getting-opt-in#retry-receipt-failures).
* **Webhook delivery failures** — Normally, Cloud API retries undelivered webhooks (such as incoming messages or receipts) for up to 7 days. With No Storage enabled, webhook retries are limited to 1 hour. If your webhook server is unavailable beyond this window, the webhook (including incoming messages, receipts, etc.) will be permanently lost. See: [Failure to Deliver Webhooks](https://developers.facebook.com/documentation/business-messaging/whatsapp/getting-opt-in#failure-to-deliver-webhooks).
