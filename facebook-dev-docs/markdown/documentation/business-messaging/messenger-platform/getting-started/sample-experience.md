...
source_url: https://developers.facebook.com/documentation/business-messaging/messenger-platform/getting-started/sample-experience
---
...
This tutorial guides you through everything you need to know to build your first Messenger experience. Before you begin, choose one of the options under [Starter Projects](https://developers.facebook.com/documentation/business-messaging/messenger-platform/getting-started/sample-experience#starter) to get the code you need to start, then follow the steps under [Getting Started](https://developers.facebook.com/documentation/business-messaging/messenger-platform/getting-started/sample-experience#getting_started) to get set up.

To run the finished code, [fork it on GitHub⁠](https://github.com/fbsamples/messenger-platform-samples/tree/master/quick-start).

### Contents

* [Starter Project](https://developers.facebook.com/documentation/business-messaging/messenger-platform/getting-started/sample-experience#starter)
* [Get Started](https://developers.facebook.com/documentation/business-messaging/messenger-platform/getting-started/sample-experience#getting_started)
* [Build the Experience](https://developers.facebook.com/documentation/business-messaging/messenger-platform/getting-started/sample-experience#build)
...
![Token Generation panel in app settings with a Page dropdown and empty Page Access Token field](https://scontent.fdel1-7.fna.fbcdn.net/v/t39.2365-6/21880169_1674641772566050_8350580527064940544_n.png?_nc_cat=101&_nc_map=urlgen_bucketless&ccb=1-7&_nc_sid=e280be&_nc_ohc=luIQVV_Sv8kQ7kNvwEQE0V2&_nc_oc=Adqz654CRmOSFPKtjzNvhc2thd1DbXNZq92FZOc9Ipsdd5GJaUJN2JgkPtvg1K2ExhSpM9fsPETl5JntMD__ckxq&_nc_zt=14&_nc_ht=scontent.fdel1-7.fna&_nc_gid=P-pOBCTT91QqAOVS1MhiXg&_nc_ss=7b289&oh=00_AQCzTlGI5OpW-L50NzmZHpJ2s8ine2x74roVMfLwFUqoTg&oe=6A6065FB)

* In the **Token Generation** section of your app's Messenger settings, select the Facebook Page you want to generate a token for from the **Page** dropdown. An access token will appear in the **Page Access Token** field.
* Click the **Page Access Token** field to copy the token to your clipboard.
...
If you completed one of the options in the [Starter Project](https://developers.facebook.com/documentation/business-messaging/messenger-platform/getting-started/sample-experience#starter) section above, you should have a basic `/webhook` endpoint that accepts `POST` requests and logs the body of received webhook events that looks like this:
...
![Messenger conversation showing the echo response to a text message](https://scontent.fdel1-1.fna.fbcdn.net/v/t39.2365-6/651193025_1459945602530756_248014944894474888_n.png?_nc_cat=100&_nc_map=urlgen_bucketless&ccb=1-7&_nc_sid=e280be&_nc_ohc=fHaFTC4w4l0Q7kNvwGLNsnX&_nc_oc=AdoqRrFTbFkhr1F_UpVDdpY0zjqTYNvmT2etr2sZNS5EZ4gUp9ZuovETlAyZaBYi1R58yOmQJlLGqq4azUgMo3m-&_nc_zt=14&_nc_ht=scontent.fdel1-1.fna&_nc_gid=P-pOBCTT91QqAOVS1MhiXg&_nc_ss=7b289&oh=00_AQAwEa8YUyYFhWpJzO2awfLaU89sV309FZb-V0O7U_oRuA&oe=6A606E48)
...
![Messenger conversation showing the generic template response with an image and postback buttons](https://scontent.fdel1-2.fna.fbcdn.net/v/t39.2365-6/651690036_1459945679197415_5126650271800155767_n.png?_nc_cat=109&_nc_map=urlgen_bucketless&ccb=1-7&_nc_sid=e280be&_nc_ohc=9zkpwB8JQn0Q7kNvwH1R6dC&_nc_oc=AdpUVsCeSChE18FcMCrdhnXk-UT_GCsII5diAM_eFUS5W5aJaxStE5Saf_MaGige8tPwlsJWb3KBitYMc984Uvwa&_nc_zt=14&_nc_ht=scontent.fdel1-2.fna&_nc_gid=P-pOBCTT91QqAOVS1MhiXg&_nc_ss=7b289&oh=00_AQBILTsaAcJ5sHhG2R7zimFqco6hFexZJBHHj_CbZ8BbpA&oe=6A605E13)
...
![Messenger conversation showing different text responses for each postback button](https://scontent.fdel1-8.fna.fbcdn.net/v/t39.2365-6/653709857_1459945589197424_8992472264603771484_n.png?_nc_cat=100&_nc_map=urlgen_bucketless&ccb=1-7&_nc_sid=e280be&_nc_ohc=82I7U1zXr1YQ7kNvwGH06YN&_nc_oc=AdqRaVXWSX2-bNfMxTlCAiJk_dU-3UWnGgbwdogFYrh2X77TKpoYsd1WOpXBD2G6bx_URYX3BfanjB9YLY2bCtSV&_nc_zt=14&_nc_ht=scontent.fdel1-8.fna&_nc_gid=P-pOBCTT91QqAOVS1MhiXg&_nc_ss=7b289&oh=00_AQDgQhj2OKSs4jWuUPQMLeFdmsYrrO0YDgX4R-oujWvu9A&oe=6A607637)
