---
title: "Overview for the Messenger Platform"
source_url: https://developers.facebook.com/documentation/business-messaging/messenger-platform/overview/rate-limiting
---
...
| [Access levels](https://developers.facebook.com/docs/graph-api/overview/access-levels) | **Standard Access** (default) limits data to users with a Role on your app or Page. **Advanced Access** extends data access to all app users and requires [App Review](https://developers.facebook.com/docs/app-review). |
