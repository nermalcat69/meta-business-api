---
title: "Send a utility message"
source_url: https://developers.facebook.com/documentation/business-messaging/messenger-platform/send-messages/templates
---
...
* Create a template
* Receive approval (within seconds of creation)
* Send a message

#### Use an existing Page-owned template

* Search for a template (already approved)
* Send a message

**Note:** Facebook Pages are not required to be linked to a business to send utility messages.

![Side-by-side of a utility message template with placeholders and the filled-in message sent to a consumer](https://scontent.fdel1-2.fna.fbcdn.net/v/t39.2365-6/652657104_1459945485864101_3844678865154611518_n.png?_nc_cat=110&_nc_map=urlgen_bucketless&ccb=1-7&_nc_sid=e280be&_nc_ohc=Fb93JEZ88lYQ7kNvwFUNxew&_nc_oc=AdrVz79T-tYcUf5XJtAQf_dXYzhXCjRVsUBhHnrd8XFODJr55TxjQ3csuYQeljV892Dz66a36kVyh0Psn0pXCD73&_nc_zt=14&_nc_ht=scontent.fdel1-2.fna&_nc_gid=6LOynmgZD-anLH86-HO70A&_nc_ss=7b289&oh=00_AQBx8nnW9zFhytvnikelLmF0AuShefb8icmrInpO482tzg&oe=6A6062B9)
