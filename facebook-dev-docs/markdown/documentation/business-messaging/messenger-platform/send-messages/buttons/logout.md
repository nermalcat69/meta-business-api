---
title: "Log in button"
source_url: https://developers.facebook.com/documentation/business-messaging/messenger-platform/send-messages/buttons/logout
---
...
| `url` | String | [Authentication](https://developers.facebook.com/documentation/business-messaging/messenger-platform/identity/account-linking) callback URL. Must use HTTPS protocol. |
