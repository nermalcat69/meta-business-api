...
source_url: https://developers.facebook.com/documentation/business-messaging/messenger-platform/ads/ads-welcome-message-flows
---
...
* [Create an ad campaign](https://developers.facebook.com/documentation/business-messaging/messenger-platform/ads/ads-welcome-message-flows#campaign)
* [Create an ad set that links your ads to your ad campaign](https://developers.facebook.com/documentation/business-messaging/messenger-platform/ads/ads-welcome-message-flows#adset)
* [Create an ad creative for the Messenger Ad type you want to serve](https://developers.facebook.com/documentation/business-messaging/messenger-platform/ads/ads-welcome-message-flows#ad-creative)
* [Create an ad by linking your ad creative to your ad set](https://developers.facebook.com/documentation/business-messaging/messenger-platform/ads/ads-welcome-message-flows#ad)
* [Publish your ad to Facebook, Instagram, and Messenger](https://developers.facebook.com/documentation/business-messaging/messenger-platform/ads/ads-welcome-message-flows#publish-ad)
...
* Visit our
  [Ad Account Campaign Endpoint Reference](https://developers.facebook.com/documentation/ads-commerce/marketing-api/reference/ad-account/campaigns#Creating)
...
| --- | --- |
| `access_token` | Your Page access token |
| `bid_amount`*int* | The maximum amount you want to pay for a result based on your optimization\_goal |
| `billing_event`*enum* | Must be set to `IMPRESSIONS`. Meta bills you when your ad is shown to people |
| `campaign_id`*int* | The ID for your campaign from [Step 1](https://developers.facebook.com/documentation/business-messaging/messenger-platform/ads/ads-welcome-message-flows#campaign) |
...
![](https://scontent.fdel1-5.fna.fbcdn.net/v/t39.2365-6/347858631_657893412828132_4893960285967998993_n.png?_nc_cat=107&_nc_map=urlgen_bucketless&ccb=1-7&_nc_sid=e280be&_nc_ohc=mQdyMARcJYMQ7kNvwE6LKHn&_nc_oc=AdqyuosVQeb8l9YDY7N4i9ooIXdBEmlfAKbh6KGuy7Y-q6MVWiyHF_DpZoPmy0CIo9NX0f85VTw34E-ekBQsy35-&_nc_zt=14&_nc_ht=scontent.fdel1-5.fna&_nc_gid=kY4w9uVd8LfN5OPml8tRhg&_nc_ss=7b289&oh=00_AQA-_NzImikYcEq0MsIbSUGyWL4H8-pzEr7yfq4i53T3Yw&oe=6A6086AB)
...
To create an ad creative for a Click to Messenger ad, send a `POST` request to the `/act_ad_account_id/adcreatives` endpoint where ***ad\_account\_id*** is the ID for your Meta ad account. Your request must include:
...
| `message` | The Welcome text for the first message you send to the person after they click on the call to action button. You can also send a default template or a series of up to 5 template messages. [Learn more.](https://developers.facebook.com/documentation/business-messaging/messenger-platform/reference/send-api) |
...
| `video_id` | Meta ID for the video. [Learn more about uploading assets to Meta servers.](https://developers.facebook.com/documentation/business-messaging/messenger-platform/reference/attachment-upload-api) |
...
To create an ad creative for a Click to Subscribe ad, send a `POST` request to the `/act_ad_account_id/adcreatives` endpoint where ***ad\_account\_id*** is the ID for your Meta ad account. Your request must include:
...
To create a message template, send a `POST` request to the `/page_id/messenger_lead_forms` endpoint where ***page\_id*** is the ID for your business' Facebook Page. Your request must include:
...
***For mult-photo post, it will add product extensions after converting the multi-photo to video.**  
Formatted for readability. Replace **bold, italics values**, such as **ad\_account\_id**, with your values.*
...
To create the ad you need to associate the ad creative and the ad set. To create the ad, send a `POST` request to the `/act_ad_account_id/ads` endpoint where ***ad\_account\_id*** is the ID for your Meta ad account. Your request must included:

* `access_token`
* `adset_id` (from [Step 2](https://developers.facebook.com/documentation/business-messaging/messenger-platform/ads/ads-welcome-message-flows#adset))
* `creative_id` (from [Step 3](https://developers.facebook.com/documentation/business-messaging/messenger-platform/ads/ads-welcome-message-flows#ad-creative))
* `name`
* `status`
...
You can publish your ad from the ads manager or using the API. To publish using the API, repeat [Step 4](https://developers.facebook.com/documentation/business-messaging/messenger-platform/ads/ads-welcome-message-flows#ad) with the `status` parameter set to `ACTIVE`.
