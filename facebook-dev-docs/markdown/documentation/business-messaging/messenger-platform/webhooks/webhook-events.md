---
title: "Meta Webhooks for Messenger Platform"
source_url: https://developers.facebook.com/documentation/business-messaging/messenger-platform/webhooks/webhook-events
---
...
* Create an endpoint on your server to receive and process your Webhooks notifications, JSON objects
* Configure the Meta Webhooks product in your App Dashboard
* Subscribe to the Meta Webhooks notifications you want to receive
* Install your messaging app on the Facebook Page linked to your business or your Instagram Professional account
...
* Select your app in the **Application** dropdown menu.
