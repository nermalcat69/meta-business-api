---
title: "App Links"
source_url: https://developers.facebook.com/documentation/applinks
---
...
**[Adding App Links to Your Existing Content](https://developers.facebook.com/documentation/applinks/add-to-content)**  
...
**[Implementations](https://developers.facebook.com/documentation/applinks/implementations)**  
...
**[Support Incoming Links for iOS](https://developers.facebook.com/documentation/applinks/ios)**  
...
**[Support Incoming Links for Android](https://developers.facebook.com/documentation/applinks/android)**  
Support incoming links to your Android app.

## Navigation Protocol

**[Support Outbound Links to Other Apps](https://developers.facebook.com/documentation/applinks/navigation-protocol)**  
Learn how to link to other apps using the Meta App Links Index API and the App Links Navigation Protocol.

**[Meta App Links Index API](https://developers.facebook.com/documentation/applinks/index-api)**  
Meta provides a Graph API endpoint to look up data for URLs that support the App Links standard.

**[Metadata Reference](https://developers.facebook.com/documentation/applinks/metadata-reference)**  
