---
title: "Business Login for Instagram"
source_url: https://developers.facebook.com/documentation/instagram-platform/instagram-api-with-instagram-login/messaging-api
---
...
| `scope` **Required** *List* | A comma-separated or URL-encoded space-separated list of [permissions](https://developers.facebook.com/documentation/instagram-platform/overview#authorization) to request from the app user. |
