---
title: "Asset Design Guidelines"
source_url: https://developers.facebook.com/documentation/games/acquire/overview
---
...
| Asset | Dimensions | Format | Max File Size | Required |
| --- | --- | --- | --- | --- |
| **Game Icon** | 800 x 800 px | PNG or JPG | 1 MB | Yes |
| **Cover Image (Landscape)** | 1200 x 630 px | PNG or JPG | 1 MB | Yes |
| **Cover Image (Square)** | 1080 x 1080 px | PNG or JPG | 1 MB | Yes |
| **Gameplay Video** | 1280 x 720 px (minimum) | MP4 | 50 MB | Yes |
| **Banner Image** | 1200 x 400 px | PNG or JPG | 1 MB | Recommended |
| **Screenshots** | At least 800 px wide | PNG or JPG | 1 MB each | Recommended (3+ suggested) |

All images should be exported at the highest quality possible within the file size limits. Avoid heavy JPEG compression that introduces visible artifacts.

## Game Icon

The game icon is the single most important asset for discoverability. It appears in the Gaming Tab, search results, game tiles, notification icons, leaderboard entries, and shared content. Players decide whether to tap on your game based largely on this icon.

### Specifications

* **Dimensions:** 800 x 800 pixels (square).
* **Format:** PNG (preferred for crisp edges) or JPG.
...
* **Do not include borders or outlines.** Let the icon fill the entire canvas edge-to-edge.
* **Do not use a plain screenshot.** The icon is not a screenshot of gameplay. It is a designed, iconic representation of your game.
* **Do not include Facebook, Meta, or other platform branding.**
* **Do not use misleading imagery.** The icon must represent your actual game. Using artwork from a more polished or different game is grounds for rejection.
...
The square cover image is used in square layout contexts across the platform, including some mobile discovery surfaces and promotional placements.
...
* **Minimum resolution:** 1280 x 720 pixels (720p). Higher resolutions (1080p or 4K) are preferred.
...
* **Do not include text overlays** with marketing messages, calls to action, or promotional content.
* **Do not include content from other games or apps.**
* **Do not include external branding** (e.g., app store logos, device manufacturer logos).
* **Do not include player-identifying information** such as real names, photos, or friend lists in the capture.

## Banner Image

The banner image is used in some promotional and editorial placements on the Gaming Tab and other discovery surfaces.
...
Screenshots provide additional visual context on the game detail page. They help players understand different aspects of your game beyond what the cover image and video show.
...
* **Quantity:** At least 3 recommended, up to 8.

### Guidelines

* **Capture different aspects of gameplay.** Show variety: the core gameplay, a menu or progression screen, a social feature, a boss fight, different levels, etc.
* **Use actual screenshots from the game.** Do not use mockups, wireframes, or images from a different version of the game.
* **Annotate sparingly.** Light annotations (arrows, callouts) are acceptable to highlight features, but do not cover the screenshot with text.
* **Order matters.** The first screenshot is the most prominent. Lead with your most compelling, visually impressive screenshot.

## Text Overlay Rules

Across all asset types, Facebook has guidelines regarding text in images:
...
| Good | Bad |
| --- | --- |
| 20 seconds of smooth, engaging gameplay showing the core mechanic. Starts immediately with action. | A 60-second video that starts with 15 seconds of menus and loading screens before any gameplay appears. |
| Clean capture at native resolution with consistent frame rate. | Shaky phone recording of a screen with visible reflections and audio from the recording environment. |

## Pre-Submission Checklist

Before submitting your assets, verify the following:

* Game icon is exactly 800 x 800 px with no rounded corners, no text, and a clear focal element.
* Landscape cover image is exactly 1200 x 630 px with key content in the center safe zone.
* Square cover image is exactly 1080 x 1080 px, not just a crop of the landscape image.
...
* Review the [Quality Guidelines](https://developers.facebook.com/documentation/games/launch/reviews/quality-guidelines) for the full set of quality criteria evaluated during review.
* Read about [App Review](https://developers.facebook.com/documentation/games/launch/reviews/app-review) for the permissions review process.
* When all assets and reviews are ready, proceed to [Game Launch](https://developers.facebook.com/documentation/games/launch/game-launch).
