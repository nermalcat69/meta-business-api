...
source_url: https://developers.facebook.com/documentation/ads-commerce/conversions-api/dataset-quality-api/offline-events
---
...
* [Additional Conversions Reported](https://developers.facebook.com/documentation/ads-commerce/conversions-api/dataset-quality-api/offline-events#acr-main)
* [Additional Conversions Reported per parameter](https://developers.facebook.com/documentation/ads-commerce/conversions-api/dataset-quality-api/offline-events#acr-params)
* [Additional Conversions Reported for per event](https://developers.facebook.com/documentation/ads-commerce/conversions-api/dataset-quality-api/offline-events#acr-capi-event)
* [Additional Conversions Reported for event coverage](https://developers.facebook.com/documentation/ads-commerce/conversions-api/dataset-quality-api/offline-events#acr-event-coverage)
* [Event Coverage](https://developers.facebook.com/documentation/ads-commerce/conversions-api/dataset-quality-api/offline-events#event-coverage)
* [Event Deduplication](https://developers.facebook.com/documentation/ads-commerce/conversions-api/dataset-quality-api/offline-events#event-deduplication)
* [Data Freshness](https://developers.facebook.com/documentation/ads-commerce/conversions-api/dataset-quality-api/offline-events#data-freshness)
* [Event Match Quality Diagnostics](https://developers.facebook.com/documentation/ads-commerce/conversions-api/dataset-quality-api/offline-events#emq-diagnostics)
...
![Set up direct integration screen with 'Set up with Dataset Quality API' selected and the generated access token to copy and save](https://scontent.fdel1-6.fna.fbcdn.net/v/t39.2365-6/494210872_24227227940205719_3078708776970798433_n.png?_nc_cat=108&_nc_map=urlgen_bucketless&ccb=1-7&_nc_sid=e280be&_nc_ohc=d8OvUX7WnWkQ7kNvwGlBkPS&_nc_oc=AdqfAmDs_XscGgFcYgYRLoE4sG0ZBRmXvh6cs7p1CVrt_rpY5iJvL4XfU0I9ZFTgmVQ2VZ1PALV33PosdhsKe7N7&_nc_zt=14&_nc_ht=scontent.fdel1-6.fna&_nc_gid=w3F2ecQeiRcX2jhB6LMbNA&_nc_ss=7b289&oh=00_AQC6aJZrfIH0YMJWZ9BmhHetX_ddHBv-XwcYnHu9rnSSBg&oe=6A60691F)
...
* **Advanced:** If you manage a high number of Meta datasets on behalf of other businesses and/or require higher rate limits, then the **advanced level** of the **ads\_management** app permission and app feature **Marketing API Access Tier** is required. Advanced level app permissions and features require [app review](https://developers.facebook.com/docs/resp-plat-initiatives/individual-processes/app-review).
...
**Use case**: Evaluate how quickly events are received from server versus browser. Improve frequency to real\_time when possible to get the most value from your event data.
...
**How should the partner\_agent field be formatted?**
...
* [Drive performance with an optimized Conversions API setup⁠](https://www.facebook.com/business/inspiration/video/drive-performance-optimized-conversions-api).
* [Optimizing your setup can help improve your marketing performance⁠](https://www.facebook.com/business/inspiration/video/drive-performance-optimized-conversions-api).
* [Best practices to onboard the Conversions API for partners⁠](https://www.facebook.com/business/m/conversions-api-resources).
