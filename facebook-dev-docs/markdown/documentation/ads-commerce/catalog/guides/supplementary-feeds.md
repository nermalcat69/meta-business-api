...
source_url: https://developers.facebook.com/documentation/ads-commerce/catalog/guides/supplementary-feeds
---
...
| `schedule` | [`schedule`](https://developers.facebook.com/documentation/ads-commerce/catalog/guides/supplementary-feeds#schedule) | Required | The configuration for fetching a feed in a recurrent manner. See [`schedule` object below](https://developers.facebook.com/documentation/ads-commerce/catalog/guides/supplementary-feeds#schedule) for more details. |
