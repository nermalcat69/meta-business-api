...
source_url: https://developers.facebook.com/documentation/ads-commerce/marketing-api/audiences/guides/value-based-lookalike-audiences
---
...
* [Existing Custom Audiences](https://developers.facebook.com/documentation/ads-commerce/marketing-api/audiences/guides/value-based-lookalike-audiences#custom-audience)
* [Campaign or ad set conversions](https://developers.facebook.com/documentation/ads-commerce/marketing-api/audiences/guides/value-based-lookalike-audiences#campaign)
* [Page fans](https://developers.facebook.com/documentation/ads-commerce/marketing-api/audiences/guides/value-based-lookalike-audiences#page_fan_lookalikes)

Facebook refreshes members in a lookalike every 3 days if the lookalike belongs to an ad set.

## Create

**Lookalike audiences can take 1-6 hours to fully populate.** While audiences populate, you can create and run ad sets targeting the audience. Once the audience is ready, Facebook delivers to people populated in the audience and ads delivery will catch up and work as normal. See [Delivery Status](https://developers.facebook.com/documentation/ads-commerce/marketing-api/audiences/guides/value-based-lookalike-audiences#delivery-status). Create a new lookalike audience at: `https://graph.facebook.com/{API_VERSION}/act_{AD_ACCOUNT_ID}/customaudiences`.
...
| `lookalike_spec.location_spec.geo_locations.countries`  type: array of strings | **Optional.**  Target countries. Array of country codes, see [Targeting Search API, Countries](https://developers.facebook.com/documentation/ads-commerce/marketing-api/audiences/reference/targeting-search#countries). **Example**: `'countries': ['US']` |
| `lookalike_spec.location_spec.geo_locations.country_groups`  type: array of strings | **Optional.**  Target countries in global regions and free trade areas. Array of country group codes. For full options, see [Targeting, Location, `country_groups`](https://developers.facebook.com/documentation/ads-commerce/marketing-api/audiences/reference/basic-targeting#location) and [Targeting Search, `country_groups`](https://developers.facebook.com/docs/marketing-api/targeting-search/v2.8#country_group). **Example**: `'country_groups': ['asia','mercosur']` |
