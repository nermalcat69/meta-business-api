...
source_url: https://developers.facebook.com/documentation/ads-commerce/marketing-api/reference/business/an_publisher_blocklist_categories
---
...
| --- | --- |
| `app_ids` *array<numeric string>* | List of IDs for which updates are required |
