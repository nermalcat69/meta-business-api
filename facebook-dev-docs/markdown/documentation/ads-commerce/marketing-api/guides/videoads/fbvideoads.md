...
source_url: https://developers.facebook.com/documentation/ads-commerce/marketing-api/guides/videoads/fbvideoads
---
...
* Step 1: [Provide ad creatives](https://developers.facebook.com/documentation/ads-commerce/marketing-api/guides/videoads/fbvideoads#create-ad-creative)
* Step 2: [Create ad campaign](https://developers.facebook.com/documentation/ads-commerce/marketing-api/guides/videoads/fbvideoads#create-ad-campaign)
* Step 3: [Create an ad set](https://developers.facebook.com/documentation/ads-commerce/marketing-api/guides/videoads/fbvideoads#create-ad-set)
* Step 4: [Create an ad](https://developers.facebook.com/documentation/ads-commerce/marketing-api/guides/videoads/fbvideoads#create-ad)
...
Follow the [video view creation](https://developers.facebook.com/documentation/ads-commerce/marketing-api/guides/videoads/fbvideoads#video_create), but apply Reach and Frequency to your ad set. Specify these additional parameters:
...
* **Reach people who watched a video**. From awareness to affinity and consideration. See [remarketing](https://developers.facebook.com/documentation/ads-commerce/marketing-api/guides/videoads/fbvideoads#remarketing).
* **Engage with brand and products**. Add a call-to-action to visit a specific page on your website. See [call to action](https://developers.facebook.com/documentation/ads-commerce/marketing-api/guides/videoads/fbvideoads#call_to_action).
...
**The `action_video_type` option is in limited testing.** To identify clients with the breakdown, check `CAN_USE_VIDEO_METRICS_BREAKDOWN` for the [ad account](https://developers.facebook.com/documentation/ads-commerce/marketing-api/reference/ad-account).
...
Create an unpublished Page post. `child_attachments` is an [array of link objects](https://developers.facebook.com/documentation/ads-commerce/marketing-api/guides/videoads/fbvideoads#spec). On each link object, `picture`, `name` and `description` are optional. You can post these as by the Page only with a Page access token.
...
![Carousel Ad on iOS annotated with callouts mapping fields like message, child_attachments, name, description, picture, link, and caption](https://scontent.fdel1-6.fna.fbcdn.net/v/t39.2365-6/592526578_1378922793966371_6556244734577500002_n.png?_nc_cat=105&_nc_map=urlgen_bucketless&ccb=1-7&_nc_sid=e280be&_nc_ohc=UEnKEIucx90Q7kNvwEjzs3e&_nc_oc=AdpO9k-UuVtSPujwpmqf1F2bAh6KAu8CT2b_dhrMpwfyu8TzBGeiDWLspBPk4fNoEVvQO0XJ_Grd7AgAA7MYNumv&_nc_zt=14&_nc_ht=scontent.fdel1-6.fna&_nc_gid=9D57suV6CHzq5d43zlCNSw&_nc_ss=7b289&oh=00_AQBSHPHuMBI1LJmTWDjaav79O4ROaSUvtAe7GFySM3Yy-w&oe=6A605592)
