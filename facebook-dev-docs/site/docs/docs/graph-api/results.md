...
source_url: https://developers.facebook.com/docs/graph-api/results
---
...
* `until` : A Unix timestamp or [`strtotime`](http://php.net/manual/en/function.strtotime.php?fbclid=IwZXh0bgNhZW0CMTEAYnJpZBExdDFTU2F3MEdKRXZxdWxzRXNydGMGYXBwX2lkATAAAR6WGNNTYBqkKYnABEs58GAdm5eG1M89yAAcLSnEOLxE8Rvg9M9PPmxj5E--kw_aem_m2gBCjToGxXrrnCbFop6Ng) data value that points to the end of the range of time-based data.
* `since` : A Unix timestamp or [`strtotime`](http://php.net/manual/en/function.strtotime.php?fbclid=IwZXh0bgNhZW0CMTEAYnJpZBExdDFTU2F3MEdKRXZxdWxzRXNydGMGYXBwX2lkATAAAR6WGNNTYBqkKYnABEs58GAdm5eG1M89yAAcLSnEOLxE8Rvg9M9PPmxj5E--kw_aem_m2gBCjToGxXrrnCbFop6Ng) data value that points to the start of the range of time-based data.
