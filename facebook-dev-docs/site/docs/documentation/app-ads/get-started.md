---
title: "Customize the Create and Manage app ads with Meta Ads Manager Use Case"
source_url: https://developers.facebook.com/documentation/app-ads/get-started
---
...
This guide shows you how to customize the **Create and manage app ads with Ads Manager** use case you added to your app during the [app creation process](https://developers.facebook.com/documentation/development/create-an-app).
...
* Click **+ Platform** to tell us about the platforms and app stores that host your app.
* For each platform you select, fill out the needed information.

#### Step 3. Set up App Events

* Click **Set up App Events** or **App Events > Settings** in the left side menu to configure the events you want to track.
* **Collect the Apple Advertising Identifier (IDFA) with App Events** and **Log in-app events automatically (recommended)** for Android and iOS are set to **Yes** by default.
* You can add your iTunes Connect code to the **In-App Purchase Shared Secret** if your iOS app offers auto-renewable subscription purchases.
* You can also log events for the Facebook SDK and set the **Session Timeout Interval**.
* Click **Save changes**. You should be redirected to the **Quickstart**.
...
* Click **Check app eligibility** to ensure any events chosen use the same integration method as App Installs. Resolve any eligibility issues to continue.
* Return to the App Dashboard to continue configuring your app.
...
* [App Events API](https://developers.facebook.com/documentation/app-events)
* [App Ads Developer Documentation](https://developers.facebook.com/documentation/app-ads)
