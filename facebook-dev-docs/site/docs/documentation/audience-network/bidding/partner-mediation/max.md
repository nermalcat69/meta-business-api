---
title: "Helium by Chartboost (Closed Beta)"
source_url: https://developers.facebook.com/documentation/audience-network/bidding/partner-mediation/max
---

# Helium by Chartboost (Closed Beta)

Updated: Mar 10, 2022

This topic explains how to set up the Chartboost bidding mediation partner for Audience Network.

## Before You Start

* **Audience Network SDK requirements:** 6.2.1 or later ([Android](https://developers.facebook.com/documentation/audience-network/setting-up/platform-setup/android/add-sdk) | [iOS](https://developers.facebook.com/documentation/audience-network/setting-up/platform-setup/ios/add-sdk))
* **Helium SDK requirements:** Helium Android SDK 2.0.0 or above and Helium iOS SDK 2.0.0 or above.
* **Supported formats:** Interstitial, Rewarded video.
...
* [iOS and Android Integration⁠](https://helium.chartboost.com/login)
* [Dashboard Setup⁠](https://helium.chartboost.com/login)
...
Chartboost recommends the following steps in order to optimize your experience on Helium:

* Utilize the A/B Testing functionality to determine the optimal strategy for your use case. For example:
  * Test bidding vs hybrid.
  * Test the addition of a new demand partner.
  * Test waterfall line item setup.
