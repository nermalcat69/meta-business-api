---
title: "Marketing Messages API for WhatsApp"
source_url: https://developers.facebook.com/documentation/business-messaging/whatsapp/marketing-messages/get-started
---
...
* **Boost and measure business results**: With our automatic delivery optimizations, you can reach more of the people who will find your messages valuable, which drove more reads and clicks in testing.1 You can also access measurement insights:
...
* **Enhance customer experience and engagement**: MM API for WhatsApp helps deliver more relevant and timely marketing messages to customers with features like:
