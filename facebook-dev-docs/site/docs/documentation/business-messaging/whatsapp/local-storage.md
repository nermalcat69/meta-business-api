...
source_url: https://developers.facebook.com/documentation/business-messaging/whatsapp/local-storage
---
...
Cloud API processes messages on servers in [Meta data centers⁠](https://datacenters.atmeta.com/all-locations/?fbclid=IwZXh0bgNhZW0CMTAAYnJpZBExdDFTU2F3MEdKRXZxdWxzRXNydGMGYXBwX2lkEDIyMjAzOTE3ODgyMDA4OTIAAR5J5kmLHA84EWOFemal61-gW0Y5zfQczb8X4KH1wc8Nc5BhJNo5H-xDF5sQnA_aem_qDHlFtYuXGfURZ2lVg3_CQ). If a business opts to use Cloud API Local Storage, message data is stored in data centers located in another [designated country](https://developers.facebook.com/documentation/business-messaging/whatsapp/local-storage).
...
In order to send and receive messages through Cloud API, Cloud API manages the encryption/decryption keys on behalf of the business. For more detail, see the [WhatsApp Encryption Overview technical whitepaper⁠](https://www.whatsapp.com/security/WhatsApp-Security-Whitepaper.pdf?fbclid=IwZXh0bgNhZW0CMTAAYnJpZBExdDFTU2F3MEdKRXZxdWxzRXNydGMGYXBwX2lkEDIyMjAzOTE3ODgyMDA4OTIAAR6yJFkTtuDg0tLo-aFvx0LyrffE_jiKUP49dNh8q_LAbuCLBZ3FLxyubtALKA_aem_dQXszfOKFIurLs7Mm86hXA).
...
* For customers in the European Region, see the [WhatsApp Business Data Transfer Addendum⁠](https://www.whatsapp.com/legal/business-data-transfer-addendum?fbclid=IwZXh0bgNhZW0CMTAAYnJpZBExdDFTU2F3MEdKRXZxdWxzRXNydGMGYXBwX2lkEDIyMjAzOTE3ODgyMDA4OTIAAR5yJrHcf9LlmmAA61e4Qqdo5DlmeDKylGVE5Amw4jFy8eZODo5p6JlDFBThdA_aem_JML49oDurRCuYk4IF_35FQ).
* For customers in the UK, see the [WhatsApp Business UK Data Transfer Addendum⁠](https://www.whatsapp.com/legal/business-data-transfer-addendum-uk?fbclid=IwZXh0bgNhZW0CMTAAYnJpZBExdDFTU2F3MEdKRXZxdWxzRXNydGMGYXBwX2lkEDIyMjAzOTE3ODgyMDA4OTIAAR6gwexikZHh6O5OgfgVCl6ObW04fHV051uBeovCJcvWZMb7XNWINGb67sn_OA_aem_uSflQzRg2Le-qwwXoC5lfg).

See the applicable [WhatsApp Business Data Processing Terms⁠](https://www.whatsapp.com/legal/business-data-processing-terms?fbclid=IwZXh0bgNhZW0CMTAAYnJpZBExdDFTU2F3MEdKRXZxdWxzRXNydGMGYXBwX2lkEDIyMjAzOTE3ODgyMDA4OTIAAR6mWph_2mfzc6F03tOU8mk-Fvz8S-T1LQVixZkshhQBi-pAo01kJrYK27rULQ_aem_Y6oRZf9hUv-IW099wSLVKw) or [Meta Hosting Terms for Cloud API⁠](https://www.facebook.com/legal/Meta-Hosting-Terms-Cloud-API) for an applicable list of sub-processors.
