---
title: "Messaging and Calling Health Status"
source_url: https://developers.facebook.com/documentation/business-messaging/whatsapp/support/load-testing
---
...
* `LIMITED`: Indicates that the node meets messaging or calling requirements, but has some limitations. If a given node has this value, [additional info](https://developers.facebook.com/documentation/business-messaging/whatsapp/support/load-testing#additional-info-property) will be included.
* `BLOCKED`: Indicates that the node does not meet one or more messaging or calling requirements. If a given node has this value, the [errors property](https://developers.facebook.com/documentation/business-messaging/whatsapp/support/load-testing#errors-property) will be included which describes the error and a possible solution.
