...
source_url: https://developers.facebook.com/documentation/business-messaging/whatsapp/embedded-signup/versions
---
...
![Embedded Signup opt-in screen for automatic event identification](https://scontent.fdel1-5.fna.fbcdn.net/v/t39.2365-6/503425036_1029531339304862_7305936950282438326_n.png?_nc_cat=106&_nc_map=urlgen_bucketless&ccb=1-7&_nc_sid=e280be&_nc_ohc=JtJbN_MbRD0Q7kNvwFLSLc-&_nc_oc=AdrXcJ-6J2IUrMLTbdpAiKDQPP_0luc1CIzkFA85pZrvZ-2RJvBKASsJ6pV_7LkGZ93x3pZscGsNbmTNLkbkFz1D&_nc_zt=14&_nc_ht=scontent.fdel1-5.fna&_nc_gid=7RvJxA1JneeIccgMZ75sow&_nc_ss=7b2a8&oh=00_AQBtz_PhiAvUGPBr-SXFMg2m89aaf42HJg-UD3QHFpUX2A&oe=6A605E4D)

If a business customer opts in, Meta uses a combination of regex and natural language processing to analyze the customer’s new message threads originating from Click-to-WhatsApp ads. If our analysis determines that a lead gen or purchase event occurred, an [automatic\_events](https://developers.facebook.com/documentation/business-messaging/whatsapp/webhooks/reference/automatic_events) webhook is triggered, describing the event. You can then report the event for the customer using the [Conversions API](https://developers.facebook.com/documentation/ads-commerce/conversions-api) so the customer can use it on a Meta surface (in 2026, see [Limitations](https://developers.facebook.com/documentation/business-messaging/whatsapp/embedded-signup/versions#limitations) below).

To learn more about how this feature works, see these [additional resources⁠](https://meta.highspot.com/items/6839e4fecd0bb354418ee7ec?fbclid=IwZXh0bgNhZW0CMTAAYnJpZBExdDFTU2F3MEdKRXZxdWxzRXNydGMGYXBwX2lkEDIyMjAzOTE3ODgyMDA4OTIAAR6KdcceqiNNYqymDpYm9KBjPTP58va7haSvNArot6NrPGxcy44C-DWeG8LGSQ_aem_z4TvYbYJHXtlJ8Vgw1kNGw).
...
* In the [Business Asset Creation Screen](https://developers.facebook.com/documentation/business-messaging/whatsapp/embedded-signup/default-flow#business-asset-creation-screen), check the **Instruct Meta to automatically identify order and lead events** checkbox, and complete the flow.
...
![A WhatsApp Business account selected in the Meta Business Suite's settings panel, with the summary tab showing checkboxes for opting in.](https://scontent.fdel1-4.fna.fbcdn.net/v/t39.2365-6/503429874_596845240111750_4726469615509960636_n.png?_nc_cat=111&_nc_map=urlgen_bucketless&ccb=1-7&_nc_sid=e280be&_nc_ohc=UpNjc-Xmf0gQ7kNvwG6rNX3&_nc_oc=AdqeOj3RtouIjURD06xz9Sm4qCog13tE9cbtdTSHpyjhpwIbtMuJq7d-I0tI0rqwPmlU6fdKafOpYckR8svkomMd&_nc_zt=14&_nc_ht=scontent.fdel1-4.fna&_nc_gid=7RvJxA1JneeIccgMZ75sow&_nc_ss=7b2a8&oh=00_AQCEt3O6IeUJjo-XYXdR5sB10ogxfN7zSwT-7xWX8aHU6Q&oe=6A604DEB)
...
* Scroll down to **Privacy and data sharing** in the **Summary** tab.
