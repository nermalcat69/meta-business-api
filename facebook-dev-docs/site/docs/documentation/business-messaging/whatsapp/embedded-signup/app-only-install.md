...
![Embedded Signup business information screen with optional Business website field and My business does not have a website checkbox](https://scontent.fdel1-7.fna.fbcdn.net/v/t39.2365-6/467331606_2133248890410157_3569145607260288812_n.png?_nc_cat=109&_nc_map=urlgen_bucketless&ccb=1-7&_nc_sid=e280be&_nc_ohc=frIsYHQjDHQQ7kNvwEEy7Ln&_nc_oc=AdpHXT3ib6MAGQdQ_y1VkQHpxuhYih0XkQjv5HOi2G62Bo0a9haXlom__4Mp0Bqwe89dAG_s0LFf-LINTrcCmHWU&_nc_zt=14&_nc_ht=scontent.fdel1-7.fna&_nc_gid=TPExiLZgLkrt5RBe54zlvQ&_nc_ss=7b2a8&oh=00_AQC37ZRKdJZPbxe_nXfIBKV9Pgg_5Z6GRIzVILJroj1USA&oe=6A606F44)
...
However, the [account\_update webhook](https://developers.facebook.com/documentation/business-messaging/whatsapp/embedded-signup/app-only-install#webhook) that's triggered when the customer completes the flow will have `event` set to `PARTNER_CLIENT_CERTIFICATION_NEEDED`, which indicates that you must verify their business as part of the onboarding process.
