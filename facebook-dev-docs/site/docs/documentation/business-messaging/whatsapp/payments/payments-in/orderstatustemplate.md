...
source_url: https://developers.facebook.com/documentation/business-messaging/whatsapp/payments/payments-in/orderstatustemplate
---
...
* Fill in template components such as `Header`, `Body`, and optional `footer` text and submit.
