---
title: "Onboard Businesses with Marketing Message API for Messenger"
source_url: https://developers.facebook.com/documentation/business-messaging/messenger-platform/marketing-messages-on-messenger/get-subscription-tokens
---
...
* Complete App Review for the following permissions before serving clients:
  ...
  * `business_management` (required for Flow 3: Partner Billing Flow)
...
* In the Meta App Dashboard, click **Configurations** under Facebook Login for Business in the menu to the left.
* Click **Create Configuration**.
* **Add a name** for this configuration and click **Next**.
* In the **Choose login variation** section, select **General** and click **Next**.
* In the **Choose access token** section, select **System-business access token**.
* In the **Choose token expiration** section, select **Never** and click **Next**.
* In the **Choose assets** section, select **Pages** and then **Asset Required**, and **Ad accounts** and then **Asset Required**.
* Click **Next**.
* In the **Choose permissions** section, add the following permissions:
  * `ads_management`
  * `pages_messaging`
...
* **Add a name** for this configuration and click **Next**.
* In the **Choose login variation** section, select **General** and click **Next**.
* In the **Choose access token** section, select **User access token** and click **Next**.
* In the **Choose permissions** section, add the following permissions:
  * `ads_management`
  * `pages_messaging`
  * `marketing_messages_messenger`**Important:** Do NOT add `paid_marketing_messages` permission for this flow.
* Click **Create**.
...
* In the **Choose access token** section, select **System-business access token**.
* In the **Choose token expiration** section, select **Never** and click **Next**.
* In the **Choose assets** section, select **Pages** and then **Asset Required**. Do **not** select Ad accounts.
* Click **Next**.
* In the **Choose permissions** section, add the following permissions:
  * `ads_management`
  * `pages_messaging`
...
* Click **Generate Access Token** to trigger the login flow.
* After you complete the login flow in the pop-up window, a new access token is shown in the Graph API Explorer.
