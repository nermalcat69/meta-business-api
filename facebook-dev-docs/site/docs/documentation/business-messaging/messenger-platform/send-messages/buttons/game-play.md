...
source_url: https://developers.facebook.com/documentation/business-messaging/messenger-platform/send-messages/buttons/game-play
---
...
| --- | --- | --- |
| `type` | String | Must be `account_unlink`. |
