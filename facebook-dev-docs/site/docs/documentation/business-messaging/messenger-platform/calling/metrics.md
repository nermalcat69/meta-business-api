---
title: "Call Settings"
source_url: https://developers.facebook.com/documentation/business-messaging/messenger-platform/calling/metrics
---
...
| `time`  *Unix timestamp* | Time at which Meta processes the call settings update and sends the webhook |
