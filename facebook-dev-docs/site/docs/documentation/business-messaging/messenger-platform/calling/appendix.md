...
source_url: https://developers.facebook.com/documentation/business-messaging/messenger-platform/calling/appendix
---
...
### Generate the SDP answer from a SDP renegotiation offer from a media\_update\_webhook
