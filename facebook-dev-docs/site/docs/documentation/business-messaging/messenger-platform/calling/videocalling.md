---
title: "Initiate and end a call"
source_url: https://developers.facebook.com/documentation/business-messaging/messenger-platform/calling/videocalling
---
...
| `session` *JSON* | Connection information containing:   * `sdp`: SDP offer compliant with [RFC 4566⁠](https://datatracker.ietf.org/doc/html/rfc4566) * `sdp_type`: Set to `offer` |
