---
title: "IG User Mentioned Comment"
source_url: https://developers.facebook.com/documentation/instagram-platform/instagram-graph-api/reference/ig-user/tags
---
...
| `like_count` *String* | Number of times the IG Comment has been liked. |
| `media` *String* | ID of the IG Media on which the IG Comment was made. Use [Field Expansion](https://developers.facebook.com/documentation/instagram-platform/instagram-graph-api/reference/ig-user/tags#field-expansion) to get additional fields on the returned IG Media entity. |
...
**v10.0 and older calls until September 7, 2021:** The [`like_count`](https://developers.facebook.com/documentation/instagram-platform/reference/instagram-media#fields) field on an IG Media will return `0` if the media [owner](https://developers.facebook.com/documentation/instagram-platform/overview#authorization) has [hidden⁠](https://www.facebook.com/help/instagram/113355287252104) like counts on it.
