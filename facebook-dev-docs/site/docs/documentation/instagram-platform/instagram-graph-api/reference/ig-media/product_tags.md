...
source_url: https://developers.facebook.com/documentation/instagram-platform/instagram-graph-api/reference/ig-media/product_tags
---
...
| `<HOST_URL>` | The [host URL](https://developers.facebook.com/documentation/instagram-platform/instagram-graph-api/reference/ig-media/product_tags#requirements) your app is using to query the endpoint. |
...
| `breakdown` | `<LIST_OF_BREAKDOWNS>` | Designates how to [break down results into subsets](https://developers.facebook.com/documentation/instagram-platform/instagram-graph-api/reference/ig-media/product_tags#breakdowns). |
| `metric` | `<LIST_OF_METRICS>` | **Required.** Comma-separated list of [metrics](https://developers.facebook.com/documentation/instagram-platform/instagram-graph-api/reference/ig-media/product_tags#metrics) you want returned. |
...
| `impressions`  For media created after July 2, 2024, this metric is deprecated. For media created before July 2, 2024, this metric will still be available.  Total number of times your app user's Instagram Media object has been seen. | `FEED` (posts) `STORY` |
| `likes`  Number of likes on the media object. | `FEED` (posts) `REELS` |
| `link_clicks`  The number of taps on links in your story. | `STORY` |
...
| `replies`  Total number of replies ([IG Comments](https://developers.facebook.com/documentation/instagram-platform/instagram-graph-api/reference/ig-comment)) on the story [IG Media](https://developers.facebook.com/documentation/instagram-platform/reference/instagram-media) object. Value does not include replies made by users in some regions. These regions include: Europe starting December 1, 2020 and Japan starting April 14, 2021. If the Story was created by a user in one of these regions, returns a value of `0`. | `STORY` |
...
| `name` | String | [Metric](https://developers.facebook.com/documentation/instagram-platform/instagram-graph-api/reference/ig-media/product_tags#metrics) name. |
...
| `values` | Array | An array containing an object describing requested [metric](https://developers.facebook.com/documentation/instagram-platform/instagram-graph-api/reference/ig-media/product_tags#metrics) values. |
| `value` | Integer | For `data.values.value`, sum of requested [metric](https://developers.facebook.com/documentation/instagram-platform/instagram-graph-api/reference/ig-media/product_tags#metrics) values.   For `data.total_value.value`, sum of requested [breakdown](https://developers.facebook.com/documentation/instagram-platform/instagram-graph-api/reference/ig-media/product_tags#breakdowns) values.   For `data.total_value.breakdowns.results.value`, sum of [breakdown](https://developers.facebook.com/documentation/instagram-platform/instagram-graph-api/reference/ig-media/product_tags#breakdowns) set values. |
| `title` | String | [Metric](https://developers.facebook.com/documentation/instagram-platform/instagram-graph-api/reference/ig-media/product_tags#metrics) title. |
| `description` | String | [Metric](https://developers.facebook.com/documentation/instagram-platform/instagram-graph-api/reference/ig-media/product_tags#metrics) description. |
| `id` | String | A string describing the query's path parameters. |
| `total_value` | Object | Object describing requested [breakdown](https://developers.facebook.com/documentation/instagram-platform/instagram-graph-api/reference/ig-media/product_tags#breakdowns) values (if breakdowns were requested). |
| `breakdowns` | Array | An array of objects describing the [breakdowns](https://developers.facebook.com/documentation/instagram-platform/instagram-graph-api/reference/ig-media/product_tags#breakdowns) requested and their results. |
| `dimension_keys` | Array | Array of strings describing [breakdowns](https://developers.facebook.com/documentation/instagram-platform/instagram-graph-api/reference/ig-media/product_tags#breakdowns) requested. |
| `results` | Array | An array of objects describing each [breakdown](https://developers.facebook.com/documentation/instagram-platform/instagram-graph-api/reference/ig-media/product_tags#breakdowns) set. |
| `dimension_values` | String | An array of strings describing [breakdown](https://developers.facebook.com/documentation/instagram-platform/instagram-graph-api/reference/ig-media/product_tags#breakdowns) set values. Values can be mapped to `dimension_keys`. |
| `paging` | Object | An object containing URLs used to request the next set of results. See [Paginated Results](https://developers.facebook.com/documentation/instagram-platform/instagram-graph-api/reference/ig-media/docs/graph-api/results) for more information. |
| `previous` | String | URL to retrieve the previous page of results. See [Paginated Results](https://developers.facebook.com/documentation/instagram-platform/instagram-graph-api/reference/ig-media/docs/graph-api/results) for more information. |
| `next` | String | URL to retrieve the next page of results. See [Paginated Results](https://developers.facebook.com/documentation/instagram-platform/instagram-graph-api/reference/ig-media/docs/graph-api/results) for more information. |
