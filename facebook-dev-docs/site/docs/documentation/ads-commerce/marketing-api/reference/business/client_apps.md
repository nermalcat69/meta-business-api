...
source_url: https://developers.facebook.com/documentation/ads-commerce/marketing-api/reference/business/client_apps
---
...
| Field | Description |
| --- | --- |
| `permitted_tasks` *list<string>* | Tasks that are assignable to this ad account |
...
We are temporarily limiting access to this endpoint. Only apps that have successfully called this endpoint within the last 30 days will continue to have access.
