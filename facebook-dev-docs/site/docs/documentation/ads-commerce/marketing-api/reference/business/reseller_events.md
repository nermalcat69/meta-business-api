...
source_url: https://developers.facebook.com/documentation/ads-commerce/marketing-api/reference/business/reseller_events
---
...
This endpoint was reintroduced in May 2020. Previously, `/received_sharing_agreements` had been deprecated with the launch of [Graph API V6.0](https://developers.facebook.com/docs/graph-api/changelog/2020-02-03-endpoint-deprecations#business).
...
| `requesting_business_id` *numeric string or integer* | RequestingBusinessId |
