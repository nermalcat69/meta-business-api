...
source_url: https://developers.facebook.com/documentation/ads-commerce/marketing-api/ad-creative/messaging-ads/click-to-whatsapp
---
...
* [Create an ad creative for the Instagram ad type you want to serve](https://developers.facebook.com/documentation/ads-commerce/marketing-api/ad-creative/messaging-ads/click-to-whatsapp#step-3)
...
* [Publish your ad](https://developers.facebook.com/documentation/ads-commerce/marketing-api/ad-creative/messaging-ads/click-to-whatsapp#step-5)
...
| Name | Description |
| --- | --- |
| `bid_amount`  unsigned int32 | **Required** if bid\_strategy is set to `LOWEST_COST_WITH_BID_CAP` or `COST_CAP`.  The maximum amount you want to pay for a result based on your `optimization_goal`. |
...
| `targeting`  Targeting object | **Required.**  The targeting structure of an ad that clicks to Instagram. See [Targeting](https://developers.facebook.com/documentation/ads-commerce/marketing-api/audiences/reference/basic-targeting) for more details. |
