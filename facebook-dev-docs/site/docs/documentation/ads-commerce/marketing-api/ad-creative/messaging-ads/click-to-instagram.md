...
source_url: https://developers.facebook.com/documentation/ads-commerce/marketing-api/ad-creative/messaging-ads/click-to-instagram
---
...
* [Create an ad campaign](https://developers.facebook.com/documentation/ads-commerce/marketing-api/ad-creative/messaging-ads/click-to-instagram#campaign)
* [Create an ad set that links your ads to your ad campaign](https://developers.facebook.com/documentation/ads-commerce/marketing-api/ad-creative/messaging-ads/click-to-instagram#adset)
* [Create an ad creative for the Messenger Ad type you want to serve](https://developers.facebook.com/documentation/ads-commerce/marketing-api/ad-creative/messaging-ads/click-to-instagram#ad-creative)
* [Create an ad by linking your ad creative to your ad set](https://developers.facebook.com/documentation/ads-commerce/marketing-api/ad-creative/messaging-ads/click-to-instagram#ad)
* [Publish your ad to Facebook, Instagram, and Messenger](https://developers.facebook.com/documentation/ads-commerce/marketing-api/ad-creative/messaging-ads/click-to-instagram#publish-ad)
...
| `campaign_id`*int* | The ID for your campaign from [Step 1](https://developers.facebook.com/documentation/ads-commerce/marketing-api/ad-creative/messaging-ads/click-to-instagram#campaign) |
...
![Sponsored Facebook feed ad preview with a produce image, promotional text, and a Learn More button](https://scontent.fdel1-5.fna.fbcdn.net/v/t39.2365-6/347858631_657893412828132_4893960285967998993_n.png?_nc_cat=107&_nc_map=urlgen_bucketless&ccb=1-7&_nc_sid=e280be&_nc_ohc=mQdyMARcJYMQ7kNvwE6LKHn&_nc_oc=AdqyuosVQeb8l9YDY7N4i9ooIXdBEmlfAKbh6KGuy7Y-q6MVWiyHF_DpZoPmy0CIo9NX0f85VTw34E-ekBQsy35-&_nc_zt=14&_nc_ht=scontent.fdel1-5.fna&_nc_gid=hUYAnTmNUtWOnMvIuWFxVw&_nc_ss=7b289&oh=00_AQBsdswp2TatyS5M6q1L5l-ERYpm55ENNH4XiA4c3wwjxg&oe=6A6086AB)
...
* `access_token`
* `adset_id` (from [Step 2](https://developers.facebook.com/documentation/ads-commerce/marketing-api/ad-creative/messaging-ads/click-to-instagram#adset))
* `creative_id` (from [Step 3](https://developers.facebook.com/documentation/ads-commerce/marketing-api/ad-creative/messaging-ads/click-to-instagram#ad-creative))
* `name`
* `status`
...
You can publish your ad from the ads manager or using the API. To publish using the API, repeat [Step 4](https://developers.facebook.com/documentation/ads-commerce/marketing-api/ad-creative/messaging-ads/click-to-instagram#ad) with the `status` parameter set to `ACTIVE`.
